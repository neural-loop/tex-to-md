...
\begin{document}
	...
	\begin{table}[h!]
		\begin{center}
			\begin{tabularx}{\textwidth}{| r | >{\centering\arraybackslash}X | >{\centering\arraybackslash}X | >{\centering\arraybackslash}X | c |} \hline 
				...
				\hline
				%        \multicolumn{6}{l}{\small * excluding very theoretical research}
			\end{tabularx}
	...
	%\textcolor{red}{This prior work suggests the following general lessons, which may be applicable to the NeurIPS broader impact statement:} %
	...
	%We also distill a second-order insight from the above discussion:
	%\begin{itemize}
	%    \item \textcolor{red}{Disagreements about whether a norm or requirement has been successful often turn on empirical questions}. In order to assess the success of such governance initiatives, it is necessary to have relevant \textcolor{red}{qualitative and quantitative measures} %benchmarks against which success can be measured 
	%    (e.g. reliability of evaluations, quality of statements). Only then can there be constructive deliberation on whether to continue, improve, or abandon the initiative.
	%\end{itemize}
	...
	\textbf{Anticipation}. A thorough understanding of the societal effects of AI technologies should undergird all actions intended to improve its impacts. %Other options: "Understanding of the societal effects of AI technologies provides the foundation on which actions to improve its impact can be taken." "Actions to improve the impacts of AI must rely on a foundation of understanding AI technologies' impacts on society" % 
	...
	%DELETED: Trivialisation of ethics, for example, may be less of a concern if the purpose is to raise awareness, but more so if the purpose is earlier anticipation of harms. As a result, a lack of specification of purpose can complicate the entire discussion on broader impact statement requirements.
	...
	\begin{table}[ht] 
		...
		\begin{tabular}{|r|l|}
			\hline
			\textbf{Transparency} &
			\begin{tabular}[c]{@{}l@{}}Purpose, motivation and expectations \\ Procedural transparency\\ Accountability mechanisms\end{tabular} \\ \hline
			%\rowcolor[HTML]{F2F2F2} 
			\textbf{Guidance}   & \begin{tabular}[c]{@{}l@{}}Guidance   for researchers\\ Guidance   for reviewers \\ Communication   channels\end{tabular} \\ \hline
			\textbf{Incentives} & \begin{tabular}[c]{@{}l@{}}Peer-review \\ Outside expert involvement \\ Encouragement to cite\\ Prizes\end{tabular}  \\ \hline
			%\rowcolor[HTML]{F2F2F2} 
			\textbf{Deliberation} &
			\begin{tabular}[c]{@{}l@{}}Forums   for deliberation   \\ Data-driven   deliberation    \\ Minimisation of reputational and legal   costs\end{tabular} \\ \hline
		\end{tabular}
		\caption{Tentative suggestions for the implementation of broader impact requirements.}
		\label{table2}
	\end{table}
	...
	\begin{thebibliography}{10}
		...
		%\expandafter\ifx\csname urlprefix\endcsname\relax\def{URL }\fi 
		...
		(\bibinfo{year}{2006}).
		%\newblock \url{https://doi.org/10.1177/0270467606295402}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		\newblock \bibinfo{title}{Artificial {Intelligence} and {Responsible}
			{Innovation}}.
		%\newblock In \bibinfo{editor}{M{\"u}ller, V.~C.} (ed.)
		...
		(\bibinfo{year}{2016}).
		%\newblock \url{https://doi.org/10.1007/978-3-319-26485-1_32}.
		...
		(\bibinfo{year}{2004}).
		%\newblock
		%  \url{https://www.journals.uchicago.edu/doi/abs/10.1086/scr.2004.3536972}.
		%\newblock \bibinfo{note}{Publisher: The University of Chicago Press}.
		...
		(\bibinfo{year}{2011}).
		%\newblock \url{https://doi.org/10.1525/jer.2011.6.2.71}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		%\newblock \url{https://doi.org/10.1145/3357155.3358473}.
		...
		(\bibinfo{year}{2011}).
		%\newblock \url{https://doi.org/10.1525/jer.2011.6.1.3}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		(\bibinfo{year}{2007}).
		%\newblock
		%  \url{https://heinonline.org/HOL/P?h=hein.journals/illlr101&i=757}.
		...
		(\bibinfo{year}{2007}).
		%\newblock
		%  \url{https://heinonline.org/HOL/P?h=hein.journals/illlr101&i=869}.
		...
		(\bibinfo{year}{2005}).
		%\newblock
		%  \url{https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1475-6773.2005.00353.x}.
		%\newblock \bibinfo{note}{\_eprint:
		%  https://onlinelibrary.wiley.com/doi/pdf/10.1111/j.1475-6773.2005.00353.x}.
		...
		(\bibinfo{year}{2004}).
		\newblock
		%  \url{https://sigmapubs.onlinelibrary.wiley.com/doi/abs/10.1111/j.1547-5069.2004.04047.x}.
		%\newblock \bibinfo{note}{\_eprint:
		%  https://sigmapubs.onlinelibrary.wiley.com/doi/pdf/10.1111/j.1547-5069.2004.04047.x}.
		...
		%\newblock
		%  \url{http://jama.jamanetwork.com/article.aspx?doi=10.1001/jama.291.4.476}.
		...
		\newblock
		%  \url{http://jama.jamanetwork.com/article.aspx?doi=10.1001/jama.290.3.360}.
		...
		(\bibinfo{year}{1982}).
		\newblock
		%  \url{http://jama.jamanetwork.com/article.aspx?doi=10.1001/jama.1982.03330020041027}.
		...
		%\newblock
		%  \url{http://jama.jamanetwork.com/article.aspx?doi=10.1001/jama.298.18.2196}.
		...
		(\bibinfo{year}{2008}).
		%\newblock \url{https://doi.org/10.1525/jer.2008.3.1.25}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		(\bibinfo{year}{2015}).
		%\newblock \url{https://doi.org/10.1177/1556264615614936}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		(\bibinfo{year}{2006}).
		%\newblock \url{https://doi.org/10.1525/jer.2006.1.1.67}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		%\newblock \url{https://doi.org/10.1186/1755-7682-4-19}.
		...
		%\newblock \url{https://papers.ssrn.com/abstract=2665148}.
		...
		(\bibinfo{year}{2014}).
		%\newblock \url{https://doi.org/10.1145/2602204.2602217}.
		...
		\bibinfo{year}{2015}).
		%\newblock \url{https://doi.org/10.1145/2785956.2787485}.
		...
		(\bibinfo{year}{2014}).
		%\newblock \url{https://www.pnas.org/content/111/24/8788}.
		%\newblock \bibinfo{note}{Publisher: National Academy of Sciences Section:
		%  Social Sciences}.
		...
		(\bibinfo{year}{2014}).
		%\newblock \url{https://www.pnas.org/content/111/29/10779.1}.
		%\newblock \bibinfo{note}{Publisher: National Academy of Sciences Section:
		%  Correction}.
		...
		(\bibinfo{year}{2007}).
		%\newblock \url{https://www.jstor.org/stable/43314540}.
		%\newblock \bibinfo{note}{Publisher: University of Texas at Dallas}.
		...
		(\bibinfo{year}{2009}).
		%\newblock \url{https://doi.org/10.1080/02691720903364019}.
		%\newblock \bibinfo{note}{Publisher: Routledge \_eprint:
		%  https://doi.org/10.1080/02691720903364019}.
		...
		(\bibinfo{year}{2011}).
		%\newblock
		%  \url{https://academic.oup.com/rev/article/20/3/239/1560336}.
		%\newblock \bibinfo{note}{Publisher: Oxford Academic}.
		...
		(\bibinfo{year}{2017}).
		%\newblock
		%  \url{http://www.sciencedirect.com/science/article/pii/S0048733317301014}.
		...
		(\bibinfo{year}{2010}).
		%\newblock
		%  \url{https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1539-6924.2010.01517.x}.
		%\newblock \bibinfo{note}{\_eprint:
		%  https://onlinelibrary.wiley.com/doi/pdf/10.1111/j.1539-6924.2010.01517.x}.
		...
		(\bibinfo{year}{2012}).
		%\newblock
		%  \url{https://academic.oup.com/spp/article/39/6/751/1620724}.
		%\newblock \bibinfo{note}{Publisher: Oxford Academic}.
		...
		%\newblock \url{https://www.springer.com/gp/book/9789400713550}.
		...
		(\bibinfo{year}{1999}).
		%\newblock
		%  \url{https://academic.oup.com/forestry/article/72/1/1/589116}.
		%\newblock \bibinfo{note}{Publisher: Oxford Academic}.
		...
		(\bibinfo{year}{2011}).
		%\newblock
		%  \url{https://academic.oup.com/rev/article/20/3/211/1560312}.
		%\newblock \bibinfo{note}{Publisher: Oxford Academic}.
		...
		%\newblock \url{https://doi.org/10.1145/3351095.3372860}.
		...
		%\newblock \bibinfo{note}{ArXiv: 2006.04541}.
		(\bibinfo{year}{2020}).
		...
		(\bibinfo{year}{2013}).
		%\newblock \url{https://doi.org/10.1177/0963721413480174}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		...
		\newblock \emph{\bibinfo{title}{The psychology of judgment and decision
				making.}}
		%(\bibinfo{publisher}{Mcgraw-Hill Book Company},
		(\bibinfo{year}{1993}).
		...
		(\bibinfo{year}{1986}).
		%\newblock
		%  \url{http://www.sciencedirect.com/science/article/pii/074959788690018X}.
		...
		(\bibinfo{year}{1998}).
		%\newblock \url{https://doi.org/10.1037/1089-2680.2.2.175}.
		%\newblock \bibinfo{note}{Publisher: SAGE Publications Inc}.
		
		\bibitem{responsible_research_and_innovation_toolkit_nodate}
		%\bibinfo{author}{Innovation, R. R.~a.}
		%\newblock \bibinfo{title}{Toolkit}.
		\newblock \url{https://rri-tools.eu/}.
		
		\bibitem{ai_ethics_lab_homepage_2020}
		%\bibinfo{author}{Lab, A.~E.}
		%\newblock \bibinfo{title}{Homepage} (\bibinfo{year}{2020}).
